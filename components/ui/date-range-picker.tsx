                ...
                <div className="flex py-2">
                  ...
                  <div className="flex items-center space-x-2 pr-4 py-1">
                    ...
                    <Label htmlFor="compare-mode">Compare</Label>
                                ...
                                >
                                    <SelectTrigger className="mx-auto mb-2 w-full lg:w-[180px]">
                    ...
                    {/* {!isSmallScreen && (
                        <div className="ml-2 flex flex-col items-end gap-1 border-l">
                            <div className="flex w-full flex-col items-end gap-1 pb-2 pl-2 pr-2">
                                {PRESETS.map((preset) => (
                                    <PresetButton
                                        key={preset.name}
                                        preset={preset.name}
